...
| Window opens then immediately closes | Inspect terminal output. Common: missing asset (`assets/figma/images/lice-temp-logo.png`) — make sure you ran from the repo root. |
